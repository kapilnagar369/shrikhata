            ...
            <div class="auth-box bg-dark "  style="margin: 0% !important">
                ...
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><!-- <img src="<?php echo base_url();?>/assets/images/logo.png" alt="logo" /> --><h2><b style="color: white;">Admin Sign In</b></h2></span>
                    </div>
                    <!-- Form -->
                    <?php echo $this->session->flashdata('dangermessage');?>
                    <form class="form-horizontal m-t-20" id="login"  method="Post" action="<?php echo site_url('welcome/login');?>">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" required="" value="<?php if(!empty($_COOKIE['email'])){ echo $_COOKIE['email'];}?>" name="email">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
