                                              ...
                                              <td class="col-1" >&nbsp;<span id='partytd1001<?php echo $i;?>' class="partytd"><?php echo @$vdata['party_code']; ?></span>
                                               ...
                                               <td class="col-1" ><span id="ratetd1001<?php echo $i;?>" class="ratetd"><?php echo @$vdata['id_rate']; ?></span>
                                                ...
                                                <td class="col-1" >
                                                 ...
                                                 <input step="0.01" style="color:white;<?php if(@$vdata['point']>0)  echo 'background-color:green'; else echo 'background-color:red';  ?>" onkeyup="calculateamount(this);"  type="number"  class="form-control tr_clone_add pointtd" id="pointtd1001<?php echo $i;?>"  value="<?php echo @$vdata['point']; ?>"  placeholder="0.00"  name="pointin[]"  >

                                                </td>

                                                <td class="col-1"> 

                                                  <input step="0.01" type="number" readonly=""  class="form-control tr_clone_add amounttd" required="" id="amounttd1001<?php echo $i;?>"    value="<?php echo @$vdata['gross_amount']; ?>"  name="amountin[]"  >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="submit" name="submit" id="submit" value="submit" class="btn btn-success float-right ">
                                         <button type="Submit" id="saveas" class="btn btn-primary float-right ">Save as Draft</button>
                                          <h5 class="card-title exchangeWisecls btn btn-success btn-lg float-left " data-toggle="modal" data-target="#left_modal" >Exchange wise Summry </h5>
                                    </div>
                                </div>
  ...
  <div class="modal-dialog "  style="max-width:60% !important;width:100%" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <table class="table exchangewisereport">
                                           <thead>
                                            <tr>
                                             <th>Sr.No.</th>
                                             <th>Exchange Name  </th>
