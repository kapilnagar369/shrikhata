                        ...
                        <div class="card"> 
                                    <div class="card-body">
                                     ...
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-7 text-right control-label col-form-label"><?php  echo ucwords($Client[0]['client_name']);?></label>
                                    </div>
                                ...
                                <h5 class="card-title m-b-0">Edit Profile</h5>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('welcome/addadmindetails');?>" method="post" id="login" enctype="multipart/form-data" style="margin-top: 30px;">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" placeholder="Full Name Here" value="<?php echo $Client[0]['client_name'];?>" name="name">
                                        </div>
                                    </div>
